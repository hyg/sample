...
const cred = JSON.parse(readFileSync('./.credentials/testnodefix4.json', 'utf-8'));

// Use Node.js crypto to load the private key
...
console.log('Private key from crypto:', Buffer.from(privateKeyBytes).toString('hex'));
